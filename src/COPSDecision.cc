...
COPSDecision::COPSDecision(C_Type t,const COPSObj &cops_obj)
{
...
COPSObj COPSDecision::getCOPSObj() const
{
	COPSObj obj;
...
COPSDecision &operator+(COPSDecision &csi, const COPSObj &obj) {
